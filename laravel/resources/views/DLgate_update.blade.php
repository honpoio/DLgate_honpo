                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input  type="text" name="youtube_channel_id" value="{{old ('youtube_channel_id',$row["youtube_channel_id"] )}}" class="form-control @error('youtube_channel_id') is-invalid @enderror" placeholder="YoutubeChannelIdを入力して下さい">
